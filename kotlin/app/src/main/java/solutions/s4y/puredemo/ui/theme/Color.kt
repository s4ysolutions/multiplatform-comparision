...
val WhiteBrightest = Color(0xFFF6F4F4)
...
val BuyIncognitoButtonColors = ButtonColors(
    ...
    contentColor = WhiteBrightest,
    disabledContainerColor = Gray2,
    disabledContentColor = WhiteBrightest
)
...
val BuyIncognitoBottomSheetButtonColors = ButtonColors(
    containerColor = Color(0xFFAA044A),
    contentColor = WhiteBrightest,
    disabledContainerColor = Gray2,
    disabledContentColor = WhiteBrightest
)
